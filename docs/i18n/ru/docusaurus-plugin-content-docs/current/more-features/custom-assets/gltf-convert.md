...
<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-1.webp" alt="Выбор параметра «Export...»" />

2. Во всплывающем окне опций убедитесь, что формат экспорта — «STEP», и нажмите «Export»:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-2.webp" alt="Всплывающее окно параметров экспорта" />
...
<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-3.webp" alt="Открытие файла STEP в CAD Assistant" />

3. Дождитесь импорта файла STEP. Это может занять несколько минут.

4. Нажмите иконку «Сохранить»:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-4.webp" alt="Нажатие на значок «Сохранить»" />

5. Выберите место для сохранения, затем используйте выпадающий список для переключения формата экспорта на «glb»:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-5.webp" alt="Переключение формата экспорта" />

6. Нажмите иконку шестеренки, затем включите «Merge faces within the same part»:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-6.webp" alt="Включение «Merge faces within the same part»" />

7. Нажмите иконку «Сохранить» и дождитесь завершения экспорта:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-7.webp" alt="Нажатие на значок «Сохранить»" />
