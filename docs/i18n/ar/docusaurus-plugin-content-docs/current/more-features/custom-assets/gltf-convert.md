...
<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-1.webp" alt="تحديد الخيار «Export...»" />

2. في النافذة المنبثقة للخيارات، تأكد من أن تنسيق التصدير هو "STEP« وانقر فوق »Export":

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-2.webp" alt="نافذة خيارات التصدير المنبثقة" />
...
<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-3.webp" alt="فتح ملف STEP في CAD Assistant" />

3. انتظر حتى يتم استيراد ملف STEP. قد يستغرق هذا بضع دقائق.

4. انقر فوق أيقونة «الحفظ» (Save):

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-4.webp" alt="النقر على أيقونة «حفظ»" />

5. اختر موقع الحفظ، ثم استخدم القائمة المنسدلة لتبديل تنسيق التصدير إلى "glb":

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-5.webp" alt="تبديل صيغة التصدير" />

6. انقر فوق أيقونة الترس، ثم مَكّن "Merge faces within the same part":

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-6.webp" alt="تمكين «Merge faces within the same part»" />

7. انقر فوق أيقونة «الحفظ» (Save) وانتظر حتى ينتهي التصدير:

<img src="/AdvantageScope/img/more-features/custom-assets/gltf-convert-7.webp" alt="النقر على أيقونة «حفظ»" />
