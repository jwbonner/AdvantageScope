...
<img src="/AdvantageScope/img/tab-reference/3d-field/xr-1.webp" alt="XR 按鈕" height="450" />

_上圖所示為英文介面。_

2. **XR 控制視窗**將開啟，其中包含 QR 碼與自訂 AR 體驗的[選項](#options)。要取消 XR 工作階段並中斷任何客戶端的連線，請關閉控制視窗。

<img src="/AdvantageScope/img/tab-reference/3d-field/xr-2.webp" alt="XR 視窗" height="350" />
