...
<img src="/AdvantageScope/img/tab-reference/line-graph/line-graph-1.webp" alt="折線圖示範" />
...
<img src="/AdvantageScope/img/tab-reference/line-graph/line-graph-2.webp" alt="警示視覺化" />

:::tip
要覆蓋機器人模式（自動、遙控或實用工具），請點擊「離散欄位」旁邊的三個點，然後點擊「顯示機器人模式」。

<img src="/AdvantageScope/img/tab-reference/line-graph/line-graph-3.webp" alt="機器人模式覆蓋層" />
...
<img src="/AdvantageScope/img/tab-reference/line-graph/line-graph-4.webp" alt="編輯軸範圍" height="250" />
